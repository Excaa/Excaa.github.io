...
extern class AbstractLoader extends EventDispatcher
{
	...
	*/
	...
	/**
	* If the loader has completed loading. This provides a quick check, but also ensures that the different approaches used for loading do not stack up resulting in more than one `complete` {{#crossLink "Event"}}{{/crossLink}}.
	*/
